                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="card h-100">
                                    <div class="card-header bg-info text-white">
                                        <h5 class="mb-0">Pusat Klaster (Radar Chart)</h5>
                                    </div>
                                    <div class="card-body">
                                        <canvas id="centroidRadarChart" height="300"></canvas>
                                    </div>
                                </div>
                            </div>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            // Radar Chart untuk Centroid Klaster
            // Radar Chart Initialization
            const radarCtx = document.getElementById('centroidRadarChart').getContext('2d');
            const radarDatasets = [];

            @foreach ($cluster_data['labels'] as $index => $label)
                radarDatasets.push({
                    label: '{{ $label }}',
                    data: @json($radar_data[$index] ?? [0, 0, 0]),
